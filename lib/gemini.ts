...
const SYSTEM_PROMPT =
  ...
  "이 힌트는 완성된 질문 문장이 아니라, 학생이 이미 한 질문과 비슷한 수준이거나 " +
  "거기서 한 단계 정도만 살짝 높인 사고를 유도하는 5~10자 내외의 아주 짧은 생각 단서여야 해 " +
  "(예: '다르게 선택했다면?', '두 인물을 비교하면?', '그다음엔 어떻게 됐을까?'). " +
  "완성된 질문 문장, 어려운 개념어나 추상적 표현, 큰 폭의 도약은 피해. " +
        ...
        responseSchema: {
          ...
          properties: {
            ...
            guidingComments: {
              ...
              description:
                "완성된 질문이 아닌, 학생이 다음 질문을 스스로 떠올리도록 돕는 5~10자 내외의 짧은 생각 힌트 2개",
            },
          },
